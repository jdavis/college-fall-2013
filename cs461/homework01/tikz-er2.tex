...
\author{P\'avel Calado\footnote{Contact information can be found at \texttt{http://tagus.inesc-id.pt/$\sim$pcalado}}}
\maketitle
...
\url{http://tagus.inesc-id.pt/~pcalado/tikzer2/tikz-er2.html}. You can use it
