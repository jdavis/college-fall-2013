...
\begin{homeworkProblem}
    ...
    \begin{proof}
        ...
        To prove the worst case, we need to understand how \alg{BST.add()} works.
        It recurses into either the left or right subtree dependent on the values of
        each node.
        \\

        To illicit worst case run-time, it follows that during each recursion, we
        only cut down the size of our problem by 1. This would give the
